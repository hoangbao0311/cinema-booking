...
function SearchFilter() {
  ...
  useEffect(() => {
    axios.get("https://r636qt-3000.csb.app/films").then((response) => {
  ...
  useEffect(() => {
    if (selectedFilm) {
      axios
        .get(
          `https://r636qt-3000.csb.app/showtimes?_expand=rooms&_expand=cinemas&filmsId=${selectedFilm}`
        )
        .then((response) => {
  ...
  useEffect(() => {
    if (selectedCinema) {
      axios
        .get(
          `https://r636qt-3000.csb.app/showtimes?_expand=rooms&filmsId=${selectedFilm}&cinemasId=${selectedCinema}&_expand=cinemas`
        )
        .then((response) => {
  ...
  useEffect(() => {
    if (selectedDate) {
      axios
        .get(
          `https://r636qt-3000.csb.app/showtimes?_expand=rooms&filmsId=${selectedFilm}&cinemas.name=${selectedCinema}&date=${selectedDate}`
        )
        .then((response) => {
  ...
  useEffect(() => {
    if (selectedTime) {
      axios
        .get(
          `https://r636qt-3000.csb.app/showtimes?_expand=rooms&filmsId=${selectedFilm}&cinemas.name=${selectedCinema}&date=${selectedDate}&starttime=${selectedTime}`
        )
        .then((response) => {
